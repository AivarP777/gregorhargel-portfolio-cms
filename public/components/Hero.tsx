...
>
  ...
  {/* PORTFOLIO BUTTON UNDER TITLE */}
  <Link
  href="/portfolio"
  className="
    group relative mt-5 inline-flex
    items-center justify-center

    /* --- UUS SUURUS, AINULT DESKTOP ILUS --- */
    h-[52px] sm:h-[60px] md:h-[68px] 
    lg:h-[100px] lg:px-14 lg:text-[24px]

    border border-[#29282D]
    bg-[#F5F6F1] 
    px-6 sm:px-8 text-[#29282D]
